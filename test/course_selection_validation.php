    ...
    <?php
        ...
        if (count($_POST['course']) != $course_ammount)
        {
            ...
            if ($total_credit < 15)
            {
                ...
                <div id="message">
                   <h1 align='center' id="text_alert"> Please select courses having more than or equal to 15.00 credit in total.</h1>
                </div>
            ...
            else
            {
                ...
                $query_1 = "SELECT * FROM course_table WHERE dept = '$dept' AND year = '$year' AND semester = '$semester'";
