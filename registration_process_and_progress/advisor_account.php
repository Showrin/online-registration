	...
	<!-- ========================== Header ============================== -->
		...
		<section id="notification">
			...
			<?php
			    ...
			    $query = "SELECT * FROM advisor_head_approval WHERE name = '$name' AND requested_as = 'Advisor'";
			        ...
			        while ($status = mysqli_fetch_assoc($result))
			        {
			            ...
			            <div id="table_content_container">
			                ...
			                <div id="table_content_title">
			                    <form action="advisor_account.php" method="post">
			                        <h4 align='left' id="content_style"> <font id="table_content_name"> <a href="<?php echo "student_info_for_advisor.php?roll=".$status['applicant_roll']; ?>"><?php echo $status['applicant_name']; ?></a> </font>
